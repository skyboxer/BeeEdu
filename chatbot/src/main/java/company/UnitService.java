...
public  class UnitService extends  BaseServlet{
    /**
     * 重要提示代码中所需工具类
     ...
     * 下载
     */
    private  void utterance(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        // 请求URL
    ...
    //查询车费
    public String queryFare(ArrayList list, String[] journeyList){
        try {
            Object o = list.get(0);
