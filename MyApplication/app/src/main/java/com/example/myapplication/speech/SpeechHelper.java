...
import com.example.base.StringUtil;
...
public class SpeechHelper {
    ...
    private String COMPOUND_SPEED="50";//设置合成语速
    private String COMPOUND_TONES="50";//设置合成音调
    private String COMPOUND_VOICE="50";//设置合成音量
    private String VOICE_STREAM_TYPE="3";//音频六类型


    // 语音合成对象
    private SpeechSynthesizer mTts;
    // 默认发音人
    private String mVoicer = "vixy";
    // 缓冲进度
    ...
    public void initSpeech(Context context){
        SpeechUtility.createUtility(context, "appid=" + "5afcdbda");
//        //以下语句用于设置日志开关（默认开启），设置成false时关闭语音云SDK日志打印
//        Setting.setShowLog(false);
    }

    /**设置发音人**/
    public void setVoicer(int index){
