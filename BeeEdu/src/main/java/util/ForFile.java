...
public class ForFile {
    ...
    public static boolean createFile(String fileName,String filecontent)throws IOException{
        System.out.print("我正在创建文件"+fileName+"/ 内容："+filecontent);
        Boolean bool = false;
    ...
    public static boolean delFile(String fileName) throws IOException{
        Boolean bool = false;
        String filePath = WebIATWS.getFile();
        filenameTemp = fileName;
        System.out.print("创建文件"+filenameTemp);
        File file  = new File(filenameTemp);
        try {
            if(file.exists()){
                file.delete();
...
//       // createFile("myfile", "我的梦说别停留等待,就让光芒折射泪湿的瞳孔,映出心中最想拥有的彩虹,带我奔向那片有你的天空,因为你是我的梦 我的梦");
//        //ForFile.createFile("voiceToText","您好");
//        File file0 = new File("");
